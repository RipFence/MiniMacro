...
How do you set up the macros?  Pressing the Yellow and White buttons at the same time creates an access point that you can connect to and point your browser to http://minimacro.local to bring up a configuration page.  Set the macro for each button tap or double-tap then click Save.  You can also reset the device to "factory" defaults from here.  All information is stored locally in flash.
